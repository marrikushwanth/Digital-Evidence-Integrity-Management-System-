...
if __name__ == '__main__':
    with app.app_context():
        ...
        from models import user, case, evidence, log, report
        db.create_all()
        ...
        if not User.query.filter_by(username='kushwanth').first():
            hashed_pw = bcrypt.hashpw('kushwanth'.encode('utf-8'), bcrypt.gensalt()).decode('utf-8')
            super_admin = User(
                username='kushwanth',
